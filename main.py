...
def lack_of_support(message):
    msg = bot.send_message(message.chat.id,
                           text="<b>Отсутствие поддержки</b>\n\n"
                                ...
                                "/inadequate_support - <b>Недостаточная поддержка</b> - если вы столкнулись с отсутствием поддержки сразу в нескольких областях\n\n"
...
def lack_of_direction(message):
    msg = bot.send_message(message.chat.id,
                           text="<b>Отсутствие направления</b>\n\n"
                                ...
                                "/inadequate_support - <b>Недостаточная поддержка</b> - менеджмент не поддерживает автоматизацию и она выполняется по инициативе 1 человека\n\n"
